...
const Single: React.FC = () => {
    ...
    return(
        <div className='single'>
            { titleCard === 'User' && <ViewUser item={props as IUserRows} titleCard={titleCard}/> }
            { titleCard === 'Movie' && <ViewMovie item={props as IMovie} titleCard={titleCard}/> }
            { titleCard === 'List' && <ViewList item={props as IList} titleCard={titleCard}/> }
        </div>
    )
}
